 ...
 * @param nbImagesATelecharger le nombre d'image(s) que l'on veux télécharger
 */
 ...
 * @param nbImagesATelecharger pointeur qui permettra de récuperer le nombre d'image qu'a selectionné l'utilisateur (nombre d'image(s) à télécharger)
 ...
 * 
 * @param nbFichier pointeur qui permettra de récupérer le nombre d'images totale
 ...
 * 
 * @param listeImagesClient la liste des images disponible dans le dossier du Client
...
/**
 * @brief envoi au Serveur le nombre d'images qui vont lui être transferée puis, pour chaque images
 ...
 * Ces pages sont constituées de la liste d'images récuperée dans le dossier du client.
